  ...
  def create_question():
    ...
    if 'searchTerm' in data:
      # try:
        ...
        questions = Question.query.filter(Question.question.like(f"%{searchTerm}%")).all()
  ...
  def play_quiz():
    ...
    try:
      if category_id == 0:
        ...
        questions = Question.query.order_by(func.random()).filter(Question.category==category_id).all()
